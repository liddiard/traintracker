/*
  ...
  - Added the required column `userTz` to the `PushSubscription` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_PushSubscription" (
    ...
    "userTz" TEXT NOT NULL,
    "sent" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
INSERT INTO "new_PushSubscription" ("auth", "createdAt", "endpoint", "id", "notificationType", "p256dh", "sent", "stopCode", "timeFormat", "trainId", "userTz") SELECT "auth", "createdAt", "endpoint", "id", "notificationType", "p256dh", "sent", "stopCode", "timeFormat", "trainId", 'UTC' FROM "PushSubscription";
