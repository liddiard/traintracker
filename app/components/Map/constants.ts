...
export const routeToCodeMap: Record<string, string> = {
  ...
  Canadian: 'CN',
  Ocean: 'OC',
  'Toronto–Montreal Corridor': 'TM',
  'Toronto–Ottawa Corridor': 'TO',
  'London–Toronto Corridor': 'LT',
  'Ottawa–Quebec City Corridor': 'OQ',
  'Sarnia–Toronto Corridor': 'ST',
  'Windsor–Toronto Corridor': 'WT',
